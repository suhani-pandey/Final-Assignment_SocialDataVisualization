...
An explainer Jupyter Notebook. The explainer notebook should contain all the behind the scenes data-analysis stuff, details on the dataset, why you've selected these particular visualizations, explanations methodology, etc. You link to the notebook from your main site.
...
Handing in the assignment: Simply upload the link to your main website via DTU Learn. (You host the notebook somewhere - e.g. on your GitHub site - and link to it from your website.)